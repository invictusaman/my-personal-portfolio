...
<Image
  src="/projects/spotify/project_timeline.png"
  width="2422"
  height="888"
  alt="Project Timeline for Our project"
/>
...
<Image
  src="/projects/spotify/featureextraction.png"
  width="1318"
  height="1268"
  alt="Data Collection to Feature Extraction"
/>

### Data PreProcessing & Model Building _(Tech Stack)_
...
<WideImage
  src="/projects/spotify/eda1.png"
  width="2126"
  height="1134"
  alt="Top 10 artists in Spotify"
/>

**Finding:** Pearl Jam is the number one artist on Spotify based on the number of songs, followed by Tegan and Sara, Drake.

<WideImage
  src="/projects/spotify/eda2.png"
  width="2100"
  height="1244"
  alt="Artist with highest danceability score"
/>

**Finding:** Drake songs are most danceable songs, meaning people love to dance on Drake songs, followed by Kendrick and Kanye.

<WideImage
  src="/projects/spotify/eda3.png"
  width="1954"
  height="1032"
  alt="correlation of features and label using heatmap"
/>

**Finding:** Features _energy_ and _loudness_ are highly positive correlated meaning increase in loudness increase energy and vice versa. Whereas, energy and acoustiness are highly negative correlated meaning increase in one decrease other.
...
<Image
  src="/projects/spotify/finalproduct1.png"
  width="1640"
  height="710"
  alt="final product for spotify recommendation system"
/>

<Image
  src="/projects/spotify/finalproduct2.png"
  width="1616"
  height="710"
  alt="displaying results from our model"
/>
...
<div className="mt-16 flex flex-wrap justify-center">
  <a
    href="https://1drv.ms/p/c/f403c76ab9321199/EcbCDO-Zzs9OoVGxSyCnmz0BeEuu5luDTmotD9lC2Woz0A?e=WUGiuR"
    target="_blank"
