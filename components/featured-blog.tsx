        ...
        <MaxWidthWrapper className="py-10 md:py-20">
            ...
            <div className="grid grid-cols-1 gap-14 md:grid-cols-2 md:gap-8">
                ...
                >
                                ...
                                {post.date && (
                                    <dl>
                                        <dt className="text-sm text-singleCard-foreground font-light">Published Date</dt>
                                          <dd className="text-md text-singleCard-foreground opacity-90 font-medium">{new Date(post.date).toLocaleDateString('en-US', {
                                            month: 'short',
                                            day: '2-digit',
                                            year: 'numeric'
                                         })}</dd>
                    ...
                    {post.image && (
                        <Link href={`${post.slug}`} className="w-full flex-shrink-0 px-6 lg:px-8 cursor-default">
