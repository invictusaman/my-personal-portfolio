...
export default function ProjectsFeaturedPage() {
  ...
  return (
    <MaxWidthWrapper className="py-10 md:py-20">
      ...
      <h2 className="text-xl font-bold mb-4" id="#featured-projects">
        FEATURED PROJECTS
      </h2>
      <div className="grid grid-cols-1 gap-14">
        {featuredProjects.map((project, index) => {
          // Use externalUrl if present, otherwise fall back to internal slug
          const projectHref = project.externalUrl ?? `${project.slug}`;
